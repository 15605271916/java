...
public class 日期类 {
	...
	public static void main(String[] args) {
		...
		Date d5 = new Date();
		Date d6 = new Date();
		// 结果跟运行时间有关，精确到毫秒。运行d1的时间，运行d5，d6的时间是否在同一毫秒内
		System.out.println(d1.equals(d5));// false，d1运行完成时间到d5运行完成时间，中间有一段代码，也需要运行时间，所以d1与d5时间不同
		System.out.println(d5.equals(d6));// true

		// 0-11对应1月-12月
		// 例如2021/1/15表示2021年1月15号
		// 但是2021,1,15表示2021年2月15号
